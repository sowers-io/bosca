...
## [Unreleased] <small class='text-xs'>(As of 6/2/25)</small>

### Added

- Added locking functionality for content
  - Added ability to lock/unlock collections
  - Added ability to lock/unlock metadata
  - Added permissions checks for locked content
