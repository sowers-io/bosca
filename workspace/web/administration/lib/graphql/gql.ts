 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query FindCollection($query: FindQuery!) {\n  content {\n    findCollection(query: $query) {\n      ...Collection\n    }\n  }\n}"): (typeof documents)["query FindCollection($query: FindQuery!) {\n  content {\n    findCollection(query: $query) {\n      ...Collection\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query FindMetadata($query: FindQuery!) {\n  content {\n    findMetadata(query: $query) {\n      ...Metadata\n    }\n  }\n}"): (typeof documents)["query FindMetadata($query: FindQuery!) {\n  content {\n    findMetadata(query: $query) {\n      ...Metadata\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query FindMetadataCount($query: FindQuery!) {\n  content {\n    findMetadataCount(query: $query)\n  }\n}"): (typeof documents)["query FindMetadataCount($query: FindQuery!) {\n  content {\n    findMetadataCount(query: $query)\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
