 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation BeginMetadataTransition($id: String!, $version: Int!, $state: String!, $status: String!) {\n  workflows {\n    beginTransition(\n      request: {metadataId: $id, version: $version, stateId: $state, status: $status, waitForCompletion: true}\n    )\n  }\n}"): (typeof documents)["mutation BeginMetadataTransition($id: String!, $version: Int!, $state: String!, $status: String!) {\n  workflows {\n    beginTransition(\n      request: {metadataId: $id, version: $version, stateId: $state, status: $status, waitForCompletion: true}\n    )\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
