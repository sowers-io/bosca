...
type Documents = {
    ...
    "mutation BeginCollectionTransition($id: String!, $state: String!) {\n  workflows {\n    beginTransition(\n      request: {collectionId: $id, stateId: $state, status: \"User Update\", waitForCompletion: true}\n    )\n  }\n}": typeof types.BeginCollectionTransitionDocument,
    "mutation BeginMetadataTransition($id: String!, $version: Int!, $state: String!) {\n  workflows {\n    beginTransition(\n      request: {metadataId: $id, version: $version, stateId: $state, status: \"User Update\", waitForCompletion: true}\n    )\n  }\n}": typeof types.BeginMetadataTransitionDocument,
    ...
    "query FindCollection($attributes: [FindAttributeInput!]!, $categoryIds: [String!], $offset: Int!, $limit: Int!) {\n  content {\n    findCollection(\n      attributes: $attributes\n      categoryIds: $categoryIds\n      offset: $offset\n      limit: $limit\n    ) {\n      ...Collection\n    }\n  }\n}": typeof types.FindCollectionDocument,
    "query FindMetadata($attributes: [FindAttributeInput!]!, $extension: ExtensionFilterType, $categoryIds: [String!], $contentTypes: [String!], $offset: Int!, $limit: Int!) {\n  content {\n    findMetadata(\n      attributes: $attributes\n      extensionFilter: $extension\n      categoryIds: $categoryIds\n      contentTypes: $contentTypes\n      offset: $offset\n      limit: $limit\n    ) {\n      ...Metadata\n    }\n  }\n}": typeof types.FindMetadataDocument,
    "query FindMetadataCount($attributes: [FindAttributeInput!]!, $extension: ExtensionFilterType, $categoryIds: [String!], $contentTypes: [String!]) {\n  content {\n    findMetadataCount(\n      attributes: $attributes\n      extensionFilter: $extension\n      categoryIds: $categoryIds\n      contentTypes: $contentTypes\n    )\n  }\n}": typeof types.FindMetadataCountDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation BeginCollectionTransition($id: String!, $state: String!) {\n  workflows {\n    beginTransition(\n      request: {collectionId: $id, stateId: $state, status: \"User Update\", waitForCompletion: true}\n    )\n  }\n}"): (typeof documents)["mutation BeginCollectionTransition($id: String!, $state: String!) {\n  workflows {\n    beginTransition(\n      request: {collectionId: $id, stateId: $state, status: \"User Update\", waitForCompletion: true}\n    )\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation BeginMetadataTransition($id: String!, $version: Int!, $state: String!) {\n  workflows {\n    beginTransition(\n      request: {metadataId: $id, version: $version, stateId: $state, status: \"User Update\", waitForCompletion: true}\n    )\n  }\n}"): (typeof documents)["mutation BeginMetadataTransition($id: String!, $version: Int!, $state: String!) {\n  workflows {\n    beginTransition(\n      request: {metadataId: $id, version: $version, stateId: $state, status: \"User Update\", waitForCompletion: true}\n    )\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query FindCollection($attributes: [FindAttributeInput!]!, $categoryIds: [String!], $offset: Int!, $limit: Int!) {\n  content {\n    findCollection(\n      attributes: $attributes\n      categoryIds: $categoryIds\n      offset: $offset\n      limit: $limit\n    ) {\n      ...Collection\n    }\n  }\n}"): (typeof documents)["query FindCollection($attributes: [FindAttributeInput!]!, $categoryIds: [String!], $offset: Int!, $limit: Int!) {\n  content {\n    findCollection(\n      attributes: $attributes\n      categoryIds: $categoryIds\n      offset: $offset\n      limit: $limit\n    ) {\n      ...Collection\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query FindMetadata($attributes: [FindAttributeInput!]!, $extension: ExtensionFilterType, $categoryIds: [String!], $contentTypes: [String!], $offset: Int!, $limit: Int!) {\n  content {\n    findMetadata(\n      attributes: $attributes\n      extensionFilter: $extension\n      categoryIds: $categoryIds\n      contentTypes: $contentTypes\n      offset: $offset\n      limit: $limit\n    ) {\n      ...Metadata\n    }\n  }\n}"): (typeof documents)["query FindMetadata($attributes: [FindAttributeInput!]!, $extension: ExtensionFilterType, $categoryIds: [String!], $contentTypes: [String!], $offset: Int!, $limit: Int!) {\n  content {\n    findMetadata(\n      attributes: $attributes\n      extensionFilter: $extension\n      categoryIds: $categoryIds\n      contentTypes: $contentTypes\n      offset: $offset\n      limit: $limit\n    ) {\n      ...Metadata\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query FindMetadataCount($attributes: [FindAttributeInput!]!, $extension: ExtensionFilterType, $categoryIds: [String!], $contentTypes: [String!]) {\n  content {\n    findMetadataCount(\n      attributes: $attributes\n      extensionFilter: $extension\n      categoryIds: $categoryIds\n      contentTypes: $contentTypes\n    )\n  }\n}"): (typeof documents)["query FindMetadataCount($attributes: [FindAttributeInput!]!, $extension: ExtensionFilterType, $categoryIds: [String!], $contentTypes: [String!]) {\n  content {\n    findMetadataCount(\n      attributes: $attributes\n      extensionFilter: $extension\n      categoryIds: $categoryIds\n      contentTypes: $contentTypes\n    )\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
