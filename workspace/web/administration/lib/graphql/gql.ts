...
type Documents = {
    ...
    "mutation AddDocument($parentCollectionId: String!, $templateId: String!, $templateVersion: Int!) {\n  content {\n    metadata {\n      addDocument(\n        parentCollectionId: $parentCollectionId\n        templateId: $templateId\n        templateVersion: $templateVersion\n      ) {\n        ...Metadata\n      }\n    }\n  }\n}": typeof types.AddDocumentDocument,
    "mutation AddGuide($parentCollectionId: String!, $templateId: String!, $templateVersion: Int!) {\n  content {\n    metadata {\n      addGuide(\n        parentCollectionId: $parentCollectionId\n        templateId: $templateId\n        templateVersion: $templateVersion\n      ) {\n        ...Metadata\n      }\n    }\n  }\n}": typeof types.AddGuideDocument,
    "mutation AddGuideStep($metadataId: String!, $version: Int!, $sort: Int!, $templateId: String!, $templateStepId: Int!, $templateVersion: Int!) {\n  content {\n    metadata {\n      addGuideStep(\n        metadataId: $metadataId\n        metadataVersion: $version\n        sort: $sort\n        templateId: $templateId\n        templateStepId: $templateStepId\n        templateVersion: $templateVersion\n      ) {\n        ...GuideStep\n      }\n    }\n  }\n}": typeof types.AddGuideStepDocument,
    "mutation AddGuideStepModule($metadataId: String!, $version: Int!, $stepId: Int!, $sort: Int!, $templateId: String!, $templateVersion: Int!, $templateStepId: Int!, $templateModuleId: Int!) {\n  content {\n    metadata {\n      addGuideStepModule(\n        metadataId: $metadataId\n        metadataVersion: $version\n        stepId: $stepId\n        sort: $sort\n        templateId: $templateId\n        templateVersion: $templateVersion\n        templateStepId: $templateStepId\n        templateModuleId: $templateModuleId\n      ) {\n        ...GuideStepModule\n      }\n    }\n  }\n}": typeof types.AddGuideStepModuleDocument,
    ...
    "mutation DeleteGuide($id: String!, $version: Int!) {\n  content {\n    metadata {\n      deleteGuide(metadataId: $id, metadataVersion: $version)\n    }\n  }\n}": typeof types.DeleteGuideDocument,
    "mutation DeleteGuideStep($metadataId: String!, $version: Int!, $stepId: Int!) {\n  content {\n    metadata {\n      deleteGuideStep(\n        metadataId: $metadataId\n        metadataVersion: $version\n        stepId: $stepId\n      )\n    }\n  }\n}": typeof types.DeleteGuideStepDocument,
    ...
    "query GetCollectionRelationships($id: String!) {\n  content {\n    collection(id: $id) {\n      metadataRelationships {\n        ...CollectionMetadataRelationship\n      }\n    }\n  }\n}": typeof types.GetCollectionRelationshipsDocument,
    "query GetCollectionSupplementary($id: String!, $key: String) {\n  content {\n    collection(id: $id) {\n      supplementary(key: $key) {\n        ...CollectionSupplementary\n      }\n    }\n  }\n}": typeof types.GetCollectionSupplementaryDocument,
    ...
    "query GetRunningWorkflowCount($id: String!) {\n  content {\n    metadata(id: $id) {\n      workflow {\n        running\n      }\n    }\n  }\n}": typeof types.GetRunningWorkflowCountDocument,
...
const documents: Documents = {
    ...
    "mutation AddGuide($parentCollectionId: String!, $templateId: String!, $templateVersion: Int!) {\n  content {\n    metadata {\n      addGuide(\n        parentCollectionId: $parentCollectionId\n        templateId: $templateId\n        templateVersion: $templateVersion\n      ) {\n        ...Metadata\n      }\n    }\n  }\n}": types.AddGuideDocument,
    "mutation AddGuideStep($metadataId: String!, $version: Int!, $sort: Int!, $templateId: String!, $templateStepId: Int!, $templateVersion: Int!) {\n  content {\n    metadata {\n      addGuideStep(\n        metadataId: $metadataId\n        metadataVersion: $version\n        sort: $sort\n        templateId: $templateId\n        templateStepId: $templateStepId\n        templateVersion: $templateVersion\n      ) {\n        ...GuideStep\n      }\n    }\n  }\n}": types.AddGuideStepDocument,
    "mutation AddGuideStepModule($metadataId: String!, $version: Int!, $stepId: Int!, $sort: Int!, $templateId: String!, $templateVersion: Int!, $templateStepId: Int!, $templateModuleId: Int!) {\n  content {\n    metadata {\n      addGuideStepModule(\n        metadataId: $metadataId\n        metadataVersion: $version\n        stepId: $stepId\n        sort: $sort\n        templateId: $templateId\n        templateVersion: $templateVersion\n        templateStepId: $templateStepId\n        templateModuleId: $templateModuleId\n      ) {\n        ...GuideStepModule\n      }\n    }\n  }\n}": types.AddGuideStepModuleDocument,
    ...
    "mutation DeleteGuide($id: String!, $version: Int!) {\n  content {\n    metadata {\n      deleteGuide(metadataId: $id, metadataVersion: $version)\n    }\n  }\n}": types.DeleteGuideDocument,
    "mutation DeleteGuideStep($metadataId: String!, $version: Int!, $stepId: Int!) {\n  content {\n    metadata {\n      deleteGuideStep(\n        metadataId: $metadataId\n        metadataVersion: $version\n        stepId: $stepId\n      )\n    }\n  }\n}": types.DeleteGuideStepDocument,
    ...
    "query GetCollectionRelationships($id: String!) {\n  content {\n    collection(id: $id) {\n      metadataRelationships {\n        ...CollectionMetadataRelationship\n      }\n    }\n  }\n}": types.GetCollectionRelationshipsDocument,
    "query GetCollectionSupplementary($id: String!, $key: String) {\n  content {\n    collection(id: $id) {\n      supplementary(key: $key) {\n        ...CollectionSupplementary\n      }\n    }\n  }\n}": types.GetCollectionSupplementaryDocument,
    ...
    "query GetRunningWorkflowCount($id: String!) {\n  content {\n    metadata(id: $id) {\n      workflow {\n        running\n      }\n    }\n  }\n}": types.GetRunningWorkflowCountDocument,
    ...
    "fragment CollectionSupplementary on CollectionSupplementary {\n  key\n  name\n  uploaded\n  attributes\n  content {\n    ...CollectionSupplementaryContent\n  }\n  source {\n    id\n    identifier\n  }\n}\n\nfragment CollectionSupplementaryContent on CollectionSupplementaryContent {\n  type\n  length\n  urls {\n    download {\n      url\n      headers {\n        name\n        value\n      }\n    }\n  }\n}": types.CollectionSupplementaryFragmentDoc,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation AddDocument($parentCollectionId: String!, $templateId: String!, $templateVersion: Int!) {\n  content {\n    metadata {\n      addDocument(\n        parentCollectionId: $parentCollectionId\n        templateId: $templateId\n        templateVersion: $templateVersion\n      ) {\n        ...Metadata\n      }\n    }\n  }\n}"): (typeof documents)["mutation AddDocument($parentCollectionId: String!, $templateId: String!, $templateVersion: Int!) {\n  content {\n    metadata {\n      addDocument(\n        parentCollectionId: $parentCollectionId\n        templateId: $templateId\n        templateVersion: $templateVersion\n      ) {\n        ...Metadata\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation AddGuide($parentCollectionId: String!, $templateId: String!, $templateVersion: Int!) {\n  content {\n    metadata {\n      addGuide(\n        parentCollectionId: $parentCollectionId\n        templateId: $templateId\n        templateVersion: $templateVersion\n      ) {\n        ...Metadata\n      }\n    }\n  }\n}"): (typeof documents)["mutation AddGuide($parentCollectionId: String!, $templateId: String!, $templateVersion: Int!) {\n  content {\n    metadata {\n      addGuide(\n        parentCollectionId: $parentCollectionId\n        templateId: $templateId\n        templateVersion: $templateVersion\n      ) {\n        ...Metadata\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation AddGuideStep($metadataId: String!, $version: Int!, $sort: Int!, $templateId: String!, $templateStepId: Int!, $templateVersion: Int!) {\n  content {\n    metadata {\n      addGuideStep(\n        metadataId: $metadataId\n        metadataVersion: $version\n        sort: $sort\n        templateId: $templateId\n        templateStepId: $templateStepId\n        templateVersion: $templateVersion\n      ) {\n        ...GuideStep\n      }\n    }\n  }\n}"): (typeof documents)["mutation AddGuideStep($metadataId: String!, $version: Int!, $sort: Int!, $templateId: String!, $templateStepId: Int!, $templateVersion: Int!) {\n  content {\n    metadata {\n      addGuideStep(\n        metadataId: $metadataId\n        metadataVersion: $version\n        sort: $sort\n        templateId: $templateId\n        templateStepId: $templateStepId\n        templateVersion: $templateVersion\n      ) {\n        ...GuideStep\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation AddGuideStepModule($metadataId: String!, $version: Int!, $stepId: Int!, $sort: Int!, $templateId: String!, $templateVersion: Int!, $templateStepId: Int!, $templateModuleId: Int!) {\n  content {\n    metadata {\n      addGuideStepModule(\n        metadataId: $metadataId\n        metadataVersion: $version\n        stepId: $stepId\n        sort: $sort\n        templateId: $templateId\n        templateVersion: $templateVersion\n        templateStepId: $templateStepId\n        templateModuleId: $templateModuleId\n      ) {\n        ...GuideStepModule\n      }\n    }\n  }\n}"): (typeof documents)["mutation AddGuideStepModule($metadataId: String!, $version: Int!, $stepId: Int!, $sort: Int!, $templateId: String!, $templateVersion: Int!, $templateStepId: Int!, $templateModuleId: Int!) {\n  content {\n    metadata {\n      addGuideStepModule(\n        metadataId: $metadataId\n        metadataVersion: $version\n        stepId: $stepId\n        sort: $sort\n        templateId: $templateId\n        templateVersion: $templateVersion\n        templateStepId: $templateStepId\n        templateModuleId: $templateModuleId\n      ) {\n        ...GuideStepModule\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation DeleteGuide($id: String!, $version: Int!) {\n  content {\n    metadata {\n      deleteGuide(metadataId: $id, metadataVersion: $version)\n    }\n  }\n}"): (typeof documents)["mutation DeleteGuide($id: String!, $version: Int!) {\n  content {\n    metadata {\n      deleteGuide(metadataId: $id, metadataVersion: $version)\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation DeleteGuideStep($metadataId: String!, $version: Int!, $stepId: Int!) {\n  content {\n    metadata {\n      deleteGuideStep(\n        metadataId: $metadataId\n        metadataVersion: $version\n        stepId: $stepId\n      )\n    }\n  }\n}"): (typeof documents)["mutation DeleteGuideStep($metadataId: String!, $version: Int!, $stepId: Int!) {\n  content {\n    metadata {\n      deleteGuideStep(\n        metadataId: $metadataId\n        metadataVersion: $version\n        stepId: $stepId\n      )\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetCollectionRelationships($id: String!) {\n  content {\n    collection(id: $id) {\n      metadataRelationships {\n        ...CollectionMetadataRelationship\n      }\n    }\n  }\n}"): (typeof documents)["query GetCollectionRelationships($id: String!) {\n  content {\n    collection(id: $id) {\n      metadataRelationships {\n        ...CollectionMetadataRelationship\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetCollectionSupplementary($id: String!, $key: String) {\n  content {\n    collection(id: $id) {\n      supplementary(key: $key) {\n        ...CollectionSupplementary\n      }\n    }\n  }\n}"): (typeof documents)["query GetCollectionSupplementary($id: String!, $key: String) {\n  content {\n    collection(id: $id) {\n      supplementary(key: $key) {\n        ...CollectionSupplementary\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetRunningWorkflowCount($id: String!) {\n  content {\n    metadata(id: $id) {\n      workflow {\n        running\n      }\n    }\n  }\n}"): (typeof documents)["query GetRunningWorkflowCount($id: String!) {\n  content {\n    metadata(id: $id) {\n      workflow {\n        running\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetSlug($slug: String!) {\n  content {\n    slug(slug: $slug) {\n      ... on Metadata {\n        ...Metadata\n      }\n      ... on Collection {\n        ...Collection\n      }\n    }\n  }\n}"): (typeof documents)["query GetSlug($slug: String!) {\n  content {\n    slug(slug: $slug) {\n      ... on Metadata {\n        ...Metadata\n      }\n      ... on Collection {\n        ...Collection\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "fragment CollectionSupplementary on CollectionSupplementary {\n  key\n  name\n  uploaded\n  attributes\n  content {\n    ...CollectionSupplementaryContent\n  }\n  source {\n    id\n    identifier\n  }\n}\n\nfragment CollectionSupplementaryContent on CollectionSupplementaryContent {\n  type\n  length\n  urls {\n    download {\n      url\n      headers {\n        name\n        value\n      }\n    }\n  }\n}"): (typeof documents)["fragment CollectionSupplementary on CollectionSupplementary {\n  key\n  name\n  uploaded\n  attributes\n  content {\n    ...CollectionSupplementaryContent\n  }\n  source {\n    id\n    identifier\n  }\n}\n\nfragment CollectionSupplementaryContent on CollectionSupplementaryContent {\n  type\n  length\n  urls {\n    download {\n      url\n      headers {\n        name\n        value\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
