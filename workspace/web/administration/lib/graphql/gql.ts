...
type Documents = {
    ...
    "mutation AddGuideStep($parentCollectionId: String!, $metadataId: String!, $version: Int!, $sort: Int!, $templateId: String!, $templateStepId: Int!, $templateVersion: Int!) {\n  content {\n    metadata {\n      addGuideStep(\n        parentCollectionId: $parentCollectionId\n        metadataId: $metadataId\n        version: $version\n        sort: $sort\n        templateId: $templateId\n        templateStepId: $templateStepId\n        templateVersion: $templateVersion\n      ) {\n        ...GuideStep\n      }\n    }\n  }\n}": typeof types.AddGuideStepDocument,
    "mutation AddGuideStepModule($parentCollectionId: String!, $metadataId: String!, $version: Int!, $sort: Int!, $templateId: String!, $templateVersion: Int!, $templateStepId: Int!, $templateModuleId: Int!) {\n  content {\n    metadata {\n      addGuideStepModule(\n        parentCollectionId: $parentCollectionId\n        metadataId: $metadataId\n        version: $version\n        sort: $sort\n        templateId: $templateId\n        templateVersion: $templateVersion\n        templateStepId: $templateStepId\n        templateModuleId: $templateModuleId\n      ) {\n        ...GuideStepModule\n      }\n    }\n  }\n}": typeof types.AddGuideStepModuleDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation AddGuideStep($parentCollectionId: String!, $metadataId: String!, $version: Int!, $sort: Int!, $templateId: String!, $templateStepId: Int!, $templateVersion: Int!) {\n  content {\n    metadata {\n      addGuideStep(\n        parentCollectionId: $parentCollectionId\n        metadataId: $metadataId\n        version: $version\n        sort: $sort\n        templateId: $templateId\n        templateStepId: $templateStepId\n        templateVersion: $templateVersion\n      ) {\n        ...GuideStep\n      }\n    }\n  }\n}"): (typeof documents)["mutation AddGuideStep($parentCollectionId: String!, $metadataId: String!, $version: Int!, $sort: Int!, $templateId: String!, $templateStepId: Int!, $templateVersion: Int!) {\n  content {\n    metadata {\n      addGuideStep(\n        parentCollectionId: $parentCollectionId\n        metadataId: $metadataId\n        version: $version\n        sort: $sort\n        templateId: $templateId\n        templateStepId: $templateStepId\n        templateVersion: $templateVersion\n      ) {\n        ...GuideStep\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation AddGuideStepModule($parentCollectionId: String!, $metadataId: String!, $version: Int!, $sort: Int!, $templateId: String!, $templateVersion: Int!, $templateStepId: Int!, $templateModuleId: Int!) {\n  content {\n    metadata {\n      addGuideStepModule(\n        parentCollectionId: $parentCollectionId\n        metadataId: $metadataId\n        version: $version\n        sort: $sort\n        templateId: $templateId\n        templateVersion: $templateVersion\n        templateStepId: $templateStepId\n        templateModuleId: $templateModuleId\n      ) {\n        ...GuideStepModule\n      }\n    }\n  }\n}"): (typeof documents)["mutation AddGuideStepModule($parentCollectionId: String!, $metadataId: String!, $version: Int!, $sort: Int!, $templateId: String!, $templateVersion: Int!, $templateStepId: Int!, $templateModuleId: Int!) {\n  content {\n    metadata {\n      addGuideStepModule(\n        parentCollectionId: $parentCollectionId\n        metadataId: $metadataId\n        version: $version\n        sort: $sort\n        templateId: $templateId\n        templateVersion: $templateVersion\n        templateStepId: $templateStepId\n        templateModuleId: $templateModuleId\n      ) {\n        ...GuideStepModule\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
